...
export default function ApplyCampaignForm({
  campaign,
  onCancel,
  onSuccess,
  onError,
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div>
        ...
        <textarea
          id="apply-message"
          rows={4}
          placeholder="Hi! I'm a creator with an engaged audience. I've worked with similar brands and can deliver authentic, high-converting content..."
      ...
      <div className={`flex items-center gap-3 pt-2 ${showCancel ? '' : ''}`}>
        {showCancel && onCancel && (
          <button
            type="button"
            onClick={onCancel}
